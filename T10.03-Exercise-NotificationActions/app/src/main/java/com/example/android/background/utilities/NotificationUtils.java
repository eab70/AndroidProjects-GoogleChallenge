...
import static com.example.android.background.R.drawable.ic_local_drink_black_24px;
...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 5417 ;

    private static final int ACTION_DRINK_PENDING_INTENT_ID = 6417;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                // (17) Add the two new actions created below using the addAction method and your helper methods;
                //these will show up in the notification
    ...
    //The two following methods are for the buttons that appear in the notification:
    // (5) Add a static method called ignoreReminderAction
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        // (6) Create an Intent to launch WaterReminderIntentService. This is to relaunch the
        //app and execute it in the background
    ...
    private static Bitmap largeIcon(Context context) {
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(res, ic_local_drink_black_24px);
        return largeIcon;
    }
}
