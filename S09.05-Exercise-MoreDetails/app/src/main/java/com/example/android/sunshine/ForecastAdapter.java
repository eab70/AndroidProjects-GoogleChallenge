...
//      (36) Refactor onClick to accept a long as its parameter rather than a String
...
//          (37) Instead of passing the String for the clicked item, pass the date from the cursor
