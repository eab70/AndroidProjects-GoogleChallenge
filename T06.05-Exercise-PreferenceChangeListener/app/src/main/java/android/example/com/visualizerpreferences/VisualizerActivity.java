...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        // (3) Register the listener. Note: can pass in "this" because VisualizerActivity
        //implements SharedPreferences.OnShared...
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    // (2) Override the onSharedPreferenceChanged method and update the show bass preference
    @Override
    ...
    //(4) Override onDestroy and unregister the listener
    @Override
