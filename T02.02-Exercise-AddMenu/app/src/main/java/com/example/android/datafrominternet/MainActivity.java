...
public class MainActivity extends AppCompatActivity {
    ...
    // Do 2 - 7 in menu.xml ///////////////////////////////////////////////////////////////////////
    // Create a menu xml called 'main.xml' in the res->menu folder
    // Add one menu item to your menu
    // Give the menu item an id of @+id/action_search
    // Set the orderInCategory to 1
    // Show this item if there is room (use app:showAsAction, not android:showAsAction)
    // Set the title to the search string ("Search") from strings.xml
