...
public class MainActivity extends AppCompatActivity {
    ...
    // Create a menu resource in res/menu/ called main.xml
    // Add one item to the menu with an ID of action_refresh
    // Set the title of the menu item to "Refresh" using strings.xml
    // Set the orderInCategory value to 1 to make sure this item is the first in the list
    // Set app:showAsAction to ifRoom to display the menu item in the ActionBar if there is room
