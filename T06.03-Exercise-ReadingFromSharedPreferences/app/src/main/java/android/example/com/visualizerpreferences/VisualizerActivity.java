...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        // (2) Get a reference to -- an instance of -- the default shared preferences from the PreferenceManager class
        ...
        //Need to comment out line below in order to get the above line to work (even though
        //the above line only currently works when device is rotated.
