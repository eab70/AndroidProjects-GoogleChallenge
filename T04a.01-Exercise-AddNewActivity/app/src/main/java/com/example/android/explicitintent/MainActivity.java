...
// Change the ConstraintLayout to a FrameLayout and make appropriate adjustments
// Give your TextView an ID of tv_display
// Set the text to something that indicates this is default text being displayed
// Make the text size a little larger
