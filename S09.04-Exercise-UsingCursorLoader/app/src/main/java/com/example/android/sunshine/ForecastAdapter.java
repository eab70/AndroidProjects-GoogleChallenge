...
//      (6) Move the cursor to the appropriate position
        ...
        //I tried to do this using the column names but it needs an int position which is set up in
        //MainActivity by making an array of the columnn names and then assigning each an index
//      (7) Generate a weather summary with the date, description, high and low
        ...
        String weatherSummary = dateString + " - " + description + " - " + lowInCelsius + highInCelsius;
...
//      (9) Delete the current body of getItemCount
//      (10) If mCursor is null, return 0. Otherwise, return the count of mCursor
