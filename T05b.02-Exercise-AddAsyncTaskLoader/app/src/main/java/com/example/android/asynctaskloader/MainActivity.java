...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            //(26) Remove the code that retrieves the JSO
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            mUrlDisplayTextView.setText("Please enter a query to search for.");
            return;
        }
    ...
    // (3) Override onCreateLoader and within onCreateLoader:
    // (4) Return a new AsyncTaskLoader<String> as an anonymous
    // inner class with this as the constructor's parameter
    @SuppressLint("StaticFieldLeak")
    @Override
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {

            // (5) Override onStartLoading, and within onStartLoading:
            // (6) If args is null, return,
            // (7) Show the loading indicator, and
            // (8) Force a load
            @Override
            ...
            // (9) Override loadInBackground and within loadInBackground:
    ...
    // (13) Override onLoadFinished and within onLoadFinished:
