...
public class SettingsActivity extends AppCompatActivity {
    ...
    // (3) In res->xml create a file called pref_visualizer
    // (4) In pref_visualizer create a preference screen containing a single check box preference
    ...
    // (7) Set the root layout of activity_settings to our newly created SettingsFragment
    // and remove the padding.
    // [HINT] Use a <fragment> element in xml
    // This required replacing <LinearLayout> and all its code with <fragment> and then
    // adding the code shown in the video
}