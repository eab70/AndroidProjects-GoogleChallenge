...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        // (7) Use the flightInfor attribute in mBinding below to get the appropiate text Views
        ...
        // (8) Use the boardingInfo attribute in mBinding below to get the appropiate text Views
