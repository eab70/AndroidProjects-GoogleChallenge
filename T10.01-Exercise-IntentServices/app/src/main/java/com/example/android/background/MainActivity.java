...
public class MainActivity extends AppCompatActivity implements
     ...
     */
    //This method is already set up to increment when the user clicks on the cup icon. So each
    //time the cup is clicked, the background service will increment the count. And because we've
    //set the activity to listen to the preference changes, the UI will display the updated
    //count immediately.
