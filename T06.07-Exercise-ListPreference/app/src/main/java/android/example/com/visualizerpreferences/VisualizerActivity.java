...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // (4) Update setupSharedPreferences and onSharedPreferenceChanged to load the color
    // from shared preferences. Call setColor, passing in the color you got
    //This task entailed creating a new method, loadColorFromPreferences and then calling
    //it in setupSharedPreferences and onSharedPreferencesChanged
